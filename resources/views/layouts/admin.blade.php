        ...
        <nav class="mt-8 flex-1">
            <div class="px-4 space-y-1">
                ...
                <a href="{{ route('admin.donations.index') }}"
                    class="nav-link flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.donations.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.notifications.index') }}"
                    class="nav-link flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.notifications.*') ? 'active' : '' }}">
                    <i class="fas fa-bell text-gray-500 mr-3"></i>
                    Notifications
                </a>
                <a href="{{ route('admin.reports.index') }}"
                    class="nav-link flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.reports.*') ? 'active' : '' }}">
                    <i class="fas fa-chart-bar text-gray-500 mr-3"></i>
                    Reports
                </a>
                <a href="{{ route('admin.settings.index') }}"
                    class="nav-link flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.settings.*') ? 'active' : '' }}">
            ...
            const chart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [1250, 1300, 1180, 1400, 1520, 1680, 1750, 1620, 1580, 1490, 1630,
                            1720, 1680, 1740, 1820, 1950, 2010, 1920, 1850, 1760, 1830, 1910,
                            2050, 2120, 2080, 1980, 2160, 2240, 2180, 2310
                        ],
